...
subtitle: "Session #4: Reproducible research & Web scraping"
...
.pl[
```{r, echo=F, out.width="80%", fig.cap="Source: Hardvard press on Estimating the reproducibility of psychological science"}
include_graphics("img/replication crisis.png")
```
]
...
.middle[
```{r, echo=F, out.width="80%", fig.align='center', fig.cap="Process to convert RMarkdown to other text formats"}
include_graphics("img/process.png")
```
]
...
.pr[
```{r, fig.align='center', echo=FALSE, fig.subcap="souce", fig.cap="Unstructured vs structured data."}
include_graphics("img/unst.jpg")
```
]
...
```{r, echo=F, fig.cap="Example: Top 100 movies in IMDb"}
include_graphics("img/imdb.png")
```
