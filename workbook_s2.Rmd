...
```{r, echo=FALSE, fig.align='center', fig.cap="Infinite loop!"}
...
```{r, echo=FALSE, fig.showtext="fff", out.width="100%", fig.cap="Data analysis workflow (source: Wickham & Garret, 2017)", fig.align='center'}
